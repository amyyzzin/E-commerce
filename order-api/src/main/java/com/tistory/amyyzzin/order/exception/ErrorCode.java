package com.tistory.amyyzzin.order.exception;
...
public enum ErrorCode {
    ...
    SAME_ITEM_NAME(HttpStatus.BAD_REQUEST, "아이템 중복 입니다."),
    ...
    ORDER_FAIL_NO_MONEY(HttpStatus.BAD_REQUEST, "주문 불가! 잔액을 확인해 주세요");
